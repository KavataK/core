...
// Signing difficulty
#define TARGET_TICK_VOTE_SIGNATURE 0x07FFFFFFU  // around 2500 signing operations per ID
...
#define INTERNAL_COMPUTATIONS_INTERVAL 50
#define EXTERNAL_COMPUTATIONS_INTERVAL (50 + 1)
