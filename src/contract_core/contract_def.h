...
#define Q1961_CONTRACT_INDEX 23
...
#define Q1962_CONTRACT_INDEX 24
...
#define Q2011_CONTRACT_INDEX 28
...
#define Q2012_CONTRACT_INDEX 29
...
constexpr struct ContractDescription
{
    ...
    {"QVAULT", 191, 10000, sizeof(QVAULT)}, // proposal in epoch 136, IPO in 137, construction and first use in 138
    ...
    {"Q1961", 197, 10000, sizeof(IPO)},
    {"Q1962", 197, 10000, sizeof(IPO)},
    {"Q198", 199, 10000, sizeof(IPO)},
    {"Q199", 200, 10000, sizeof(IPO)},
    {"Q200", 201, 10000, sizeof(IPO)},
    {"Q2011", 202, 10000, sizeof(IPO)},
    {"Q2012", 202, 10000, sizeof(IPO)},
